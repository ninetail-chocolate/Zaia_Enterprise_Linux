...
#}
#src={
#	"https://archive.mozilla.org/pub/firefox/releases/98.0.2/source/firefox-98.0.2.source.tar.xz"
#}
#depend{
#	"autoconf"
#	"cbindgen"
...
tar -xf src/firefox-98.0.2.source.tar.xz
cd firefox-98.0.2
...
unset CC CXX CFLAGS CXXFLAGS MACH_USE_SYSTEM_PYTHON MOZBUILD_STATE_PATH RUSTFLAGS

cd ../
#rm -rf firefox-98.0.2
