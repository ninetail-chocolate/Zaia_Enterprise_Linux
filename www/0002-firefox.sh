...
#}
#src={
#	"https://archive.mozilla.org/pub/firefox/releases/91.2.0esr/source/firefox-91.2.0esr.source.tar.xz"
#}
#depend{
#	"autoconf"
#	"cbindgen"
...
tar -xf src/firefox-91.2.0esr.source.tar.xz
cd firefox-91.2.0
