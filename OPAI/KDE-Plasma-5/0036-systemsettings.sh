...
#}
#src={
#	"https://download.kde.org/stable/plasma/5.24.3/systemsettings-5.24.3.tar.xz"
#}
#depend{
#	"kde-cli-tools"
#}
...
tar -xf src/systemsettings-5.24.3.tar.xz
cd systemsettings-5.24.3
