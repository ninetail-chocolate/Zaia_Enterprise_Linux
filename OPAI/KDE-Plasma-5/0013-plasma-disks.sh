...
#}
#src={
#	"https://download.kde.org/stable/plasma/5.24.3/plasma-disks-5.24.3.tar.xz"
#}
#depend{
#	"plasma-workspace"
#}
...
tar -xf src/plasma-disks-5.24.3.tar.xz
cd plasma-disks-5.24.3
