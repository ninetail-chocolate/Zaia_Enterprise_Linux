...
#}
#src={
#	"https://download.kde.org/stable/plasma/5.24.3/ksshaskpass-5.24.3.tar.xz"
#}
#depend{
#	"kgamma5"
#}
...
tar -xf src/ksshaskpass-5.24.3.tar.xz
cd ksshaskpass-5.24.3
