...
#}
#src={
#	"https://download.kde.org/stable/plasma/5.24.3/kde-cli-tools-5.24.3.tar.xz"
#}
#depend{
#	"plasma-vault"
#}
...
tar -xf src/kde-cli-tools-5.24.3.tar.xz
cd kde-cli-tools-5.24.3
