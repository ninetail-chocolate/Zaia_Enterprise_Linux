...
#}
#src={
#	"https://download.kde.org/stable/plasma/5.24.3/plasma-integration-5.24.3.tar.xz"
#}
#depend{
#	"kactivitymanagerd"
#}
...
tar -xf src/plasma-integration-5.24.3.tar.xz
cd plasma-integration-5.24.3
...
cd ../../
rm -rf plasma-integration-5.24.3
