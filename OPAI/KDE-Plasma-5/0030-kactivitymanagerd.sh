...
#}
#src={
#	"https://download.kde.org/stable/plasma/5.24.3/kactivitymanagerd-5.24.3.tar.xz"
#}
#depend{
#	"ksshaskpass"
#	"SQLite"
...
tar -xf src/kactivitymanagerd-5.24.3.tar.xz
cd kactivitymanagerd-5.24.3
...
cd ../../
rm -rf kactivitymanagerd-5.24.3
