...
#}
#src={
#	"https://download.kde.org/stable/frameworks/5.92/plasma-framework-5.92.0.tar.xz"
#}
#depend{
#	"KF5-pre"
#	"kwayland"
...
tar -xf src/plasma-framework-5.92.0.tar.xz
cd plasma-framework-5.92.0
