...
#}
#src={
#	"https://download.kde.org/stable/plasma/5.24.3/kdeplasma-addons-5.24.3.tar.xz"
#}
#depend{
#	"plasma-desktop"
#}
...
tar -xf src/kdeplasma-addons-5.24.3.tar.xz
cd kdeplasma-addons-5.24.3
