...
#}
#src={
#	"https://download.kde.org/stable/plasma/5.24.3/plasma-systemmonitor-5.24.3.tar.xz"
#}
#depend{
#	"systemsettings"
#}
...
tar -xf src/plasma-systemmonitor-5.24.3.tar.xz
cd plasma-systemmonitor-5.24.3
...
cd ../../
rm -rf plasma-systemmonitor-5.24.3
