...
#}
#src={
#	"https://download.kde.org/stable/plasma/5.24.3/polkit-kde-agent-1-5.24.3.tar.xz"
#}
#depend{
...
tar -xf src/polkit-kde-agent-1-5.24.3.tar.xz
cd polkit-kde-agent-1-5.24.3
...
cd ../../
rm -rf polkit-kde-agent-1-5.24.3
