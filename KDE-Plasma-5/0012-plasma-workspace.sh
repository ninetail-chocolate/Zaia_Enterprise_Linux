...
#}
#src={
#	"https://download.kde.org/stable/plasma/5.24.3/plasma-workspace-5.24.3.tar.xz"
#}
#depend{
#	"libqalculate"
#	"libksysguard"
...
tar -xf src/plasma-workspace-5.24.3.tar.xz
cd plasma-workspace-5.24.3
