...
#}
#src={
#	"https://download.kde.org/stable/plasma/5.24.3/ksystemstats-5.24.3.tar.xz"
#}
#depend{
#	"qqc2-breeze-style"
#}
...
tar -xf src/ksystemstats-5.24.3.tar.xz
cd ksystemstats-5.24.3
